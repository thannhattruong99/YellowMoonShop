...
<html>
    ...
    <body>
        ...
        <form action="createCake" enctype="multipart/form-data" method="Post">
            ...
            Create Date: <input type="date" name="txtCreatedDate" value="${param.txtCreatedDate}"/><br/>
            <c:if test="${not empty errors.createDateErr}">
                <font color="red">
                ${errors.createDateErr}
                </font><br/>
            </c:if>
            Expiration Date: <input type="date" name="txtExpirationDate" value="${param.txtExpirationDate}"/><br/>
